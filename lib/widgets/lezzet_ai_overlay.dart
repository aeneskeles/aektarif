      ...
      children: [
        ...
        if (_isOpen && showFab)
          Positioned(
            ...
            child: _LezzetAiPanel(onClose: _toggle),
          ),
        if (showFab)
          Positioned(
          right: 20,
...
class _LezzetAiPanel extends ConsumerStatefulWidget {
  const _LezzetAiPanel({required this.onClose});

  final VoidCallback onClose;

  @override
  ConsumerState<_LezzetAiPanel> createState() => _LezzetAiPanelState();
}

class _LezzetAiPanelState extends ConsumerState<_LezzetAiPanel> {
